          ...
          <div class="row">
            <div class="col-md-12 col-lg-6">
              <div class="screenWords">
                ...
                <p>
                  A Jr.Full-Stack Developer. Specializing in building
                  exceptional trending websites. Feel free to take a look at my
                  latest projects. Available @ 11AM-9PM.
                  <br />
                  ✉️ info@nikeshsharma.com.np <br />
                  📞 +977 986 186 2819
                </p>
            ...
            <div class="col-md-12 col-lg-6">
              <div class="screenImage">
                <img src="/images/main.png" alt="irene blog" />
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="sectionBox">
                  ...
                  <div class="sectionWords">
                    <h4>Construction</h4>
                    <p>
                      Advanced software solutions that take Construction into
                      the Digital Era.
                    </p>
                  </div>
                </div>
              ...
              <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="sectionBox">
                  ...
                  <div class="sectionWords">
                    <h4>Logistics</h4>
                    <p>
                      Use all the latest tech available to make your logistics
                      run like clockwork.
                    </p>
                  </div>
                </div>
